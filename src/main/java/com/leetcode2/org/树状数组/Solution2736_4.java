...
//            System.out.println(tree);
    ...
    public int[] maximumSumQueries(int[] nums1, int[] nums2, int[][] queries) throws ExecutionException, InterruptedException {
        ...
        IntStream.range(0, queries.length).parallel().forEach(indexq -> {
            int rank1 = finalMapRank.get(queries[indexq][0]);
            int rank2 = finalMapRank1.get(queries[indexq][1]);
