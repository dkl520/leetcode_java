...
public class ParallelPushBoxesAStar {
    ...
    public int minPushBox(char[][] grid) {
        ...
        Set<String> visited = ConcurrentHashMap.newKeySet(); // 使用并发集合
        ...
        while (!pq.isEmpty()) {
            ...
            // 并行处理每个方向
            List<Callable<Void>> tasks = Arrays.stream(DIRECTIONS)
                    .map(dir -> (Callable<Void>) () -> {
...
//        };
        ...
        ParallelPushBoxesAStar solution = new ParallelPushBoxesAStar();
